...
public class preCompile {
	...
	public static JComboBox<String> jSectionSelect, statusSelect, browserSelect;
	public static void main(String[] args) {
		...
		public static class secureInfoAndWriteToFile implements ActionListener {
			...
			public void actionPerformed(ActionEvent e) {
				String userNameText = preCompile.userNameText.getText();
				String eightHundredNumber = preCompile.eightHundredNumber.getText();
				String termText = preCompile.termText.getText();
				String yearText = preCompile.yearText.getText();
				String jSection = (String)preCompile.jSectionSelect.getSelectedItem();
				String status = (String)preCompile.statusSelect.getSelectedItem();
				String browser = (String)preCompile.browserSelect.getSelectedItem();
				
				String[][] allDataOnEncryptedText = encryptFollowing(userNameText, termText, yearText);
				String[] regularData = new String[] {eightHundredNumber, jSection, status, browser};
